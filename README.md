...
> **Note on Repository vs. Paper:**
> The "Control Group" experiment detailed below (using the 1xBet "Crash" game) serves as the foundational "Sanity Check" for our model architecture.
>
> While this section **was removed from the final published paper** to maintain a strict focus on the football betting market, the code and data remain in this repository. It demonstrates the rigorous pre-validation process used to ensure our Deep Learning models were capable of ignoring pure noise before being applied to sports data.
...
**APA Style**
> Shams, M. (2025). Accuracy Without Profit: A Statistical Evaluation of Machine Learning Profitability in the English Premier League. Qeios. doi:10.32388/7A61RS

**BibTeX**
```bibtex
@article{shams_2025_accuracy,
  author       = {Shams, Mostafa},
  title        = {Accuracy Without Profit: A Statistical Evaluation of Machine Learning Profitability in the English Premier League},
  journal      = {Qeios},
  year         = {2025},
  doi          = {10.32388/7A61RS},
  url          = {[https://doi.org/10.32388/7A61RS](https://doi.org/10.32388/7A61RS)}
}
